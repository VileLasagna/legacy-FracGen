     ...
     redrawRequired{redrawFlag}
{
    ...
    mainwindow = SDL_CreateWindow("SDL CUDA Toybroy - Use Mouse1 to zoom in and Mouse2 to zoom out. Press Mouse 3 to change colouring scheme",
    ...
    texture = SDL_CreateTexture(    render,
                                    ...
                                    width, height);
    SDL_SetWindowTitle(mainwindow, "SDL CUDA Toybroy - Use Mouse1 to zoom in and Mouse2 to zoom out. Press Mouse 3 to change colouring scheme");
    ...
    highlight = SurfUnq(SDL_CreateRGBSurface(0,w,h,bpp,0,0,0,0));
    ...
    SDL_SetSurfaceAlphaMod(highlight.get(),128);
}
